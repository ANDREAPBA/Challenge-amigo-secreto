...
function mostrarAmigos() {
    ...
    // Recorrer el arreglo amigos y crear elementos de lista para cada nombre.
...
function sortearAmigo() {
    ...
    mostrarAmigos();
     ...
     // Mostrar alerta cuando todos los nombres han sido sorteados
    if (amigos.length === 0) {
        setTimeout(() => {
            alert("Ya se han sortearon todos los amigos de la lista");
        }, 600);
    }
